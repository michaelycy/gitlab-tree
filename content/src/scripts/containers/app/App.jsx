...
import { applyClosedPageStyling, applyOpenedPageStyling } from '../../utils/styling';
    ...
    this.shouldShowSpanTree = () => {
      return (
        (document.querySelector('.qa-branches-select') !== null ||
          document.querySelector('.js-project-refs-dropdown')) &&
    ...
    return (
      <Fragment>
        ...
        {this.props.opened[tabId]
          ...
          : ReactDOM.createPortal(
              <Toggler handleClick={this.toggleOpenedThisTab} pinned={this.props.pinned} />,
